...
public class InfluencerProfileService {
    ...
    public String createProfile(Long userId, InfluencerProfileRequest request) {
    	...
    	InfluencerProfile profile = InfluencerProfile.builder()
    	        .user(user)
    	        .instagramFollowers(request.getInstagramFollowers().intValue())
    	        .youtubeFollowers(request.getYoutubeFollowers().intValue())
    	        .tiktokFollowers(request.getTiktokFollowers().intValue())
